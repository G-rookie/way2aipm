...
Agent 与 Workflow 架构见 [Agent + Workflow Architecture](docs/agent-workflow-architecture.zh.md)，Agent Runtime 选型决策见 [Agent Runtime 技术决策](docs/agent-runtime-decision.zh.md)，已交付范围见 [v0.22 产品规格](docs/v0.22-product-spec.zh.md)，进行中的 OpenClaw 验证见 [v0.23 产品规格](docs/v0.23-product-spec.zh.md) 与 [验证记录](docs/v0.23-openclaw-validation.zh.md)。
